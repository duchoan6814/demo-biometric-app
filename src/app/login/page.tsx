...
export default function LoginPage() {
  ...
  const handleBiometricLogin = () => {
    // TODO: Handle biometric login logic
    console.log("Biometric login triggered");
    alert("Đang xác thực sinh trắc học...");
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 flex flex-col">
      ...
      <div className="flex-1 px-6">
        ...
        <button
          ...
          className="w-full py-4 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-semibold rounded-xl shadow-lg shadow-green-500/30 transition-all active:scale-[0.98] flex items-center justify-center gap-3"
        >
          <svg
            className="w-6 h-6"
            fill="none"
