...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    setHasBiometric(storage.isBiometricEnabled() && !!storage.getBiometricToken());
  }, []);
  ...
  const handleBiometricLogin = async () => {
    ...
    try {
      const biometricToken = storage.getBiometricToken();
      ...
      const response = await loginWithBiometric(biometricToken, deviceId);
      ...
      <div className="flex-1 px-6">
        ...
        {hasBiometric && (
          ...
          >
            ...
            {biometricLoading ? "Đang xác thực..." : "Đăng nhập bằng sinh trắc học"}
          </button>
        )}
        ...
        {!hasBiometric && (
          <p className="text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <br />
            Bật trong Cài đặt sau khi đăng nhập.
          </p>
        )}
